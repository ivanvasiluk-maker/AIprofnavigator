...
- далее выдай real_solutions как 3 сценария, а не просто список профессий:
  1. пессимистичный (что делать при низком ресурсе и высоком давлении),
  2. базовый (реалистичный рабочий маршрут на текущих данных),
  3. оптимистичный (если ресурс/интеграция растут);
