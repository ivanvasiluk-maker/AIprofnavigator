...
- action_plan.today в таком случае: "Напишите в заметках три вида работ, которые вы реально умеете делать лучше всего (например: плитка, гипсокартон, мебель)."
...
- далее выдай real_solutions как 3 сценария, а не просто список профессий:
  1. быстрый сценарий (самый короткий путь к доходу),
  2. средний сценарий (баланс скорости и качества траектории),
  3. идеальный сценарий (решает системно больше всего задач, но длиннее по входу);
