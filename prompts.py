...
- closing_message — это главный финал отчёта, который человек унесёт с собой. Он должен быть живым, персонализированным и сильным.
  Структура (3-5 предложений):
  ...
  4. Завершить фразой поддержки (не терапевтической): «Это работа, а не испытание. Один проверяемый шаг — и карта начнёт двигаться.»
